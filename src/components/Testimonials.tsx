  ...
  return (
    <div className="pt-12">
      <div className="flex flex-col items-center px-28 pb-16">
        <div className="border-2 w-fit p-0.5 px-3 text-sm rounded-xl font-bold border-violet-700 text-white">
          Testimonials
        </div>
        <div className="text-7xl lg:text-5xl pt-6 font-bold tracking-tighter text-center bg-gradient-to-b from-[#210f67] to-[#083eee]  text-transparent bg-clip-text">
      ...
      <div className="overflow-hidden [mask-image:linear-gradient(to_top,transparent,black,transparent)] h-[750px] mb-12 md:mb-28 lg:mb-36">
        ...
        >
          <div className="flex items-center justify-center overflow-x-hidden pb-4 gap-4 border-white ">
