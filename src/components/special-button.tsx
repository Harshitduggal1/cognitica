...
export default function AiButton() {
  ...
  return (
    <button
      className="group relative my-8 rounded-full bg-gradient-to-b from-blue-800 via-blue-500 via-40% to-purple-600 p-1 text-white transition-transform hover:scale-110 active:scale-105 "
      onMouseEnter={() => setIsHovering(true)}
      onMouseLeave={() => setIsHovering(false)}
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-b from-blue-500 via-fuchsia-600 via-40% to-purple-500 px-4 py-2 text-white">
