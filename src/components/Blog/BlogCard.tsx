  ...
  return (
    <Link href={blog.url} className="block">
      <div className="relative h-[24rem] w-64 flex-shrink-0 overflow-hidden rounded-2xl bg-white shadow-md lg:h-[30rem] lg:w-80">
            ...
            <div className="flex flex-col">
              <div className="flex items-center space-x-2">
                <Image
                  ...
                  height={16}
                />
                <span className="bg-gradient-to-b from-[#FCD3ED] to-[#F690DF] bg-clip-text font-medium text-transparent">
                  {blog.readTime} read
                </span>
              </div>
              <p className="text-sm text-white">Written by cognitica lms</p>
            </div>
          </div>
        ...
        {/* bottom shadow */}
        <div className="absolute bottom-0 left-0 right-0 h-3/4 bg-gradient-to-b from-[#07070C] to-transparent"></div>
      </div>
    </Link>
  );
}
