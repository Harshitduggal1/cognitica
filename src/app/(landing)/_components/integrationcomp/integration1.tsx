...
export function AnimatedBeamDemo() {
  ...
  return (
    ...
    >
<WordPullUp
      className="text-xl font-extrabold tracking-[-0.02em]  bg-clip-text text-transparent text-white  md:text-7xl md:leading-[5rem]"
      words="Integrate all your favorite apps seamlessly"
    />
